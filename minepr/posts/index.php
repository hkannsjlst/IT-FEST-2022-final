...
<link rel="icon" href="img/fav.png" type="image/x-icon">
	<title>Редактор для блога </title>
...
<nav class="page__menu page__custom-settings menu">
	...
	<div class="container mt-5">
		<!-- таблица  -->
<button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#postformModal">Добавить новость</button>
<br>
<h2>Информация о постах блога </h2>
<table class="table">
	<thead>
		<tr>
		<th>ID</th>
...
<!-- Форма  -->
<div class="modal fade" id="postformModal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
